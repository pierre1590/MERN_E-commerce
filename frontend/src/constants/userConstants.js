...
export const USER_EMAIL_SENT_REQUEST = 'USER_EMAIL_SENT_REQUEST';
export const USER_EMAIL_SENT_SUCCESS = 'USER_EMAIL_PASSWORD_SUCCESS';
export const USER_EMAIL_SENT_FAIL = 'USER_EMAIL_SENT_FAIL';